...
cd minutia
bash scripts/deploy-minutia-vps.sh
```
...
```bash
docker compose --env-file .env -f docker-compose.yml -f deploy/minutia/docker-compose.vps.yml ps
docker compose --env-file .env -f docker-compose.yml -f deploy/minutia/docker-compose.vps.yml logs -f caddy minutia-web supabase-db
docker compose --env-file .env -f docker-compose.yml -f deploy/minutia/docker-compose.vps.yml pull
docker compose --env-file .env -f docker-compose.yml -f deploy/minutia/docker-compose.vps.yml up -d --build
```
